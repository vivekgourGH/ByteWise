...
const Download = () => {
  return (
    <section className="p-10 text-center text-black bg-gradient-to-br from-slate-100 to-purple-100">
      <h2 className="text-2xl text-purple-600 font-semibold">START YOUR CODING JOURNEY! 🚀</h2>
      <h3 className="text-3xl font-bold mb-6 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Join the Fun Coding Adventure!</h3>
      <p className="text-slate-700 mb-6 max-w-2xl mx-auto">Join hundreds of young coders already learning with ByteWise! Learn programming through games, build cool projects, and become a coding superstar! Perfect for kids and teens aged 8-18.</p>
